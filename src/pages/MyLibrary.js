...
const MyLibrary = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://backendbookapp-yqmj.onrender.com/api/auth/user', {
      headers: {
  ...
  const handleAddBook = (e) => {
    ...
    fetch('https://backendbookapp-yqmj.onrender.com/api/auth/library', {
      method: 'PUT',
      headers: {
  ...
  const handleStatusChange = async (bookId, status) => {
    ...
    try {
      const response = await fetch('https://backendbookapp-yqmj.onrender.com/api/auth/library/status', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
